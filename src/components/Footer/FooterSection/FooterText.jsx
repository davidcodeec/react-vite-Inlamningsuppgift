  ...
  return (
    <>
        <div className="footer-text">
            ...
            <FooterTextBox title ="Company" link_1="About" link_2="Features" link_3="Works" link_4="Careers"/>

            <FooterTextBox title ="Help" link_1="Customer Support" link_2="Delivery Details" link_3="Terms & Conditions" link_4="Privacy Policy"/>
