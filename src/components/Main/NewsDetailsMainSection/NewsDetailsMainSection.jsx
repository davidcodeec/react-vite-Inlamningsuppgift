...
const NewsDetailsMainSection = () => {
  ...
  const { currentGroup, setCurrentGroup } = useArticleContext();
    ...
    try {
      if (articleId !== undefined) {
        ...
        if (response.status === 200) {
          ...
          console.error(
            `Error fetching article with ID ${articleId}: HTTP status ${response.status}`
          );
        }
      }
    } catch (error) {
  ...
  const getNextGroup = () => {
    setCurrentGroup(
      Math.min(
        currentGroup + 1,
        Math.ceil(additionalArticles.length / articlesPerPage) - 1
      )
    );
  };
            ...
            <div className="image-spacing">
              <div className="image-spacing-text">
                ...
                <p>
                  ...
                  uspendisse dui purus, scelerisque at, vulputate vitae, pretium
                  mattis, nunc. Mauris eget neque at sem venenatis eleifend. Ut
                  nonummy. Lorem ipsum dolor sit amet, consectetuer adipiscing
                  elit. Maecenas porttitor congue massa. Fusce posuere, magna
                  sed pulvinar ultricies, purus lectus malesuada libero, sit
                  amet commodo magna eros quis urna. unc viverra imperdiet enim.
                  Fusce est. Vivamus a tellus. Pellentesque habitant morbi
                  tristique senectus et netus et malesuada fames ac turpis
                  egestas. Proin pharetra nonummy pede. Mauris et orci. Aenean
                  nec lorem. In porttitor. Donec laoreet nonummy augue.
                ...
                <p className="italic-text">
                  <i
                    className="fa-sharp fa-solid fa-quote-right fa-flip-horizontal"
                    style={{ color: "#191919" }}
                  ></i>
                  Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                  Maecenas porttitor congue massa. Fusce posuere, magna sed
                ...
                <p>
                  ...
                  Maecenas porttitor congue massa. Fusce posuere, magna sed
                  pulvinar ultricies, purus lectus malesuada libero, sit amet
                  commodo magna eros quis urna. unc viverra imperdiet enim.
                  Fusce est. Vivamus a tellus. Pellentesque habitant morbi
                  tristique senectus et netus et malesuada fames ac turpis
                  egestas.{" "}
                </p>
                ...
                <div className="button-spacing">
                  <div className="center-content">
                    <Link className="btn-white" to="projects.html">
                      Freelance
                    </Link>
                  </div>
      ...
      <section className="article-news-section">
        <div className="container">
          ...
          <div className="image-spacing">
            {additionalArticles
              .slice(
                currentGroup * articlesPerPage,
                currentGroup * articlesPerPage + articlesPerPage
              )
